        ...
        <View style={{flex:1,backgroundColor:'#FFFF'}}>
           <Header
            ...
            <View style={{
                        ...
                        >Please pray for my grandpa Richard. He’s been going through a hard time with recently losing his wife this past spring. Here is more text that you could only find in this expanded view.</Text>
